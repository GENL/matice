 ...
 * @method static array generate(?string $locale = null, bool $wrapInHtml = true) - Load the translations array and the generate a the html code to paste to the page.
 *
